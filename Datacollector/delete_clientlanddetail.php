					  ...
					  <!-- /.ace-settings-container -->
  					 ...
  					 <div class="col-xs-12">
								...
								//$cont_id=0;
                                     ...
                                     $result=mysqli_query($conn, "SELECT * FROM `users` WHERE id='$id1'");
...
$query=mysqli_query($conn, "DELETE FROM `clientslanddata` where forpayment_status='notapproved' and  id='$id'");
if($query)
{
	echo'<p class="success" style="color:#390"> መረዳእታ ኣጥፊኦም ኣለዉ</p>'; 
// header('location: newlandtaxdecidingmonth');
