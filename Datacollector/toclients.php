					...
					<div id="dt">
										...
										<thead>
													<tr>
													 ...
													 <th  rowspan='3' class="blue"> ዝተመዝገበሉ ግዜ   </th>
...
$q = "SELECT * FROM clientslandtransactions where landtransfer_status='notapproved' AND landtransfer_status2=''";

// Prepare the statement
if ($stmt = mysqli_prepare($conn, $q)) {

    // Execute the statement (no parameters to bind)
    mysqli_stmt_execute($stmt);
...
?>
													...
													<tr>
														...
														<td>
															...
															<?php echo "<a href=sellingsendtodataolletor?id=".$id." class='btn red'>Approve</a>"; ?>
