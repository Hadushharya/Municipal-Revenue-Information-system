	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3>ኩነታት መሰረተ ልምዓት,መብራህቲ,ከባብያዊ ብክለት, መረዳእታ ዝሃበ ኣካል, ዘፅንዐ ጉጅለን ዘፅደቐ መተሓባበሪን/ወኪል/   </h3></center>
					<div id="dt">
										  <thead> 
										<div class="clearfix">
                                ...
                                $q="SELECT * FROM `client` where userid='$userid'";
                            $i=0;
                              ...
                              $fullname=$row['fname'].' '.$row['mname'].' '.$row['lname'];
									...
									?>
													<tr>
														...
														<td class="hidden-480"><?php echo $row['fname'].' '.$row['mname'].' '.$row['lname']; ?></td>
														...
														<td><?php echo $row['typeoftrade']; ?></td>
														...
														<td>
															...
															<a class="green" href="add_others<?php  echo '?full='.$fullname; ?>" class="tooltip-success" data-rel="tooltip" title="Add ">
