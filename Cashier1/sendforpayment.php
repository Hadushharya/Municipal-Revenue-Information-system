				...
				<center><h3>ዝርዝር ተጠቀምቲ መሬት   </h3></center>
					...
					<div id="dt">
								...
								//$cont_id=0;
                                 ...
                                 $q="SELECT * FROM `clientslanddata` where  forpayment_status='approved' and forcashierstatus='notapproved' order by id desc";
                            $i=0;
								...
								$id=$row['id'];
									...
									?>
													<tr>
														...
														<td><?php $q1="SELECT * FROM `rule` where activity='ናይ ፅሬት'";
														...
														<td> 
													<?php if($row['forcashierstatus']=="notapproved")  
