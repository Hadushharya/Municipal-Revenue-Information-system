...
$id1=$_SESSION['SESS_ID'];
                                ...
                                $qq="SELECT * FROM `clientslanddatataxdecides` where  id='$id' and forpayment_status='approved' and userid='$id1'  order by id desc";
                            //$i=0;
                            $resulqt=mysqli_query($conn,$qq);
								 
								while ($row= mysqli_fetch_array($resulqt) ){
								$id1=$row['id'];
								$userid=$row['userid'];
								...
								$unpaidyear=$row['unpaidyear'];
								 $amountofpay=$row['amountofpay'];
								 $day=$row['day'];
								 $month=$row['month'];
								 $maincash=$row['maincash'];
                                   $bankinterest=$row['bankinterest'];
                                   $punishment=$row['punishment'];	
								   $diffrence=$row['diffrence'];
								    $differencewithpunishment=$row['differencewithpunishment'];
                                 $total=$row['total'];	
                             ...
                             <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
										...
										<div class="col-sm-10">
											<input type="text" id="form-field-1" value='<?php echo $fullname; ?>' name="fullname"  required id="fullname" placeholder=" ሽም ምስ ኣባሓጎ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div> 
										 <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="form-field-1"  value='<?php echo $kebele; ?>' name="kebele"  required id="kebele" placeholder="ቀበሌ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div> 
										 <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="form-field-1"  name="block"  value='<?php echo $block; ?>' required id="block" placeholder="ብሎክ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div> 
										...
										<div class="col-sm-10">
											<input type="text" id="form-field-1"  name="east"  value='<?php echo $east; ?>' required id="east" placeholder="ምብ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div>
										 <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="form-field-1"  name="west"  value='<?php echo $west; ?>' required id="west" placeholder="ምዕ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div>
										 <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> ሰሜን:  </label>
										<div class="col-sm-10">
											<input type="text" id="form-field-1"  name="north"  required id="north"  value='<?php echo $north; ?>' placeholder="ሰሜ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div>
										 <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> ደቡብ:  </label>
										<div class="col-sm-10">
											 <input type="text" id="form-field-1"  name="south"  value='<?php echo $south; ?>' required id="south" placeholder="ደቡ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div>
										 <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> ፋ/ቁፅሪ:  </label>
                                           <div class="col-sm-10">
											<input type="text" id="form-field-1"  name="filenumber"   value='<?php echo $filenumber; ?>' required id="filenumber" placeholder="ፋ/ቁፅሪ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div>
                                 ...
                                 <div class="form-group">
								  <label class="col-sm-2 control-label no-padding-right" for="form-field-1">ደረጃ ቦታ:  </label>
										...
										<div class="col-sm-10">
											<input type="text" id="form-field-1"  name="occupiedyear"  value='<?php echo $occupiedyear; ?>' required id="occupiedyear" placeholder="ዝተታሓዘሉ እዋን" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div>
								  ...
								  <label class="col-sm-2 control-label no-padding-right" for="form-field-1">ናይቲ መሬት ዓይነት ትሕዝቶ:  </label>
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="beginofconstruction"  value='<?php echo $beginofconstruction; ?>'required id="beginofconstruction" placeholder="ህንፀት መጀመሪ" class="col-xs-10 col-sm-5" />
									 	 </div>
									    </div>
										<div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ህንፀት መወድኢ:  </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="endofconstruction"  value='<?php echo $endofconstruction; ?>' required id="endofconstruction" placeholder="ህንፀት መጀመሪ" class="col-xs-10 col-sm-5" />
									 	 </div>
									    </div>
										<div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ክፍሊት መጀመሪ:  </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="beginpayment"  value='<?php echo $beginpayment; ?>'required id="beginpayment" placeholder="ክፍሊት መጀመሪ" class="col-xs-10 col-sm-5" />
									 	 </div>
									    </div>
										 <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ክፍሊት መወድኢ:  </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  name="endpayment" value='<?php echo $endpayment; ?>' required id="endpayment" placeholder="ክፍሊት መወድኢ" class="col-xs-10 col-sm-5" />
									 	 </div>
									    </div>
										...
										<div class="col-sm-10">
											<input type="text" id="form-field-1"  name="amountofpay"  value='<?php echo $amountofpay; ?>'required id="amountofpay" placeholder="ዝከፍሎ  መጠን ገንዘብ" class="col-xs-10 col-sm-5" />
									 	</div>
									    </div>
...
$query=mysqli_query($conn,"UPDATE `clientslanddata` SET `fullname`='$fullname',`kebele`='$kebele',
`block`='$block',`east`='$east',`west`='$west',`north`='$north',`south`='$south',`filenumber`='$filenumber',
`levelofplace`='$levelofplace',`occupiedyear`='$occupiedyear',`mainservice`='$mainservice',`kindofvolumeofland`='$kindofvolumeofland',`area`='$area',
`beginofconstruction`='$beginofconstruction',`endofconstruction`='$endofconstruction',`beginpayment`='$beginpayment',`endpayment`='$endpayment',
`amountofpay`='$amountofpay',`forpayment_status`='notapproved',`siteplan`='$siteplan',`buildingplan`='$buildingplan',
`registeredtime`=CURRENT_TIMESTAMP where  forpayment_status='notapproved' and id='$id'");
...
echo'<p class="success" style="color:#390"> Data Updated successfully</p>';                                
		  echo' <meta content="2;newlandregistration" http-equiv="refresh" />';
		// exit(); 
		 
}
else{
echo'<P style="color:red" >Ask Permission for Tax Deciders.</p>'; 
}
}
?>		
