					...
					<div id="dt">
										...
										<thead>
													<tr>
														...
														<th class='blue'>መለለይ</th>
														<th class='blue'> ሽም</th>
														<th class='blue' class="hidden-480">ሽም ኣቦ</th>

														<th class='blue'>  	 ሽም ኣቦሓጎ	</th>	
														<th class='blue'> ተጠቃሚ ሽም		</th>	
														<th class='blue'> ይሕለፍ ቃል</th>
														<th class='blue'>
...
?>
													...
													<tr>
														...
														<?php //$acc=$row['id']; ?>
															<td> 
													<?php if($row['permission']=="active")  
														
                        echo 
						"<a href=deactivateaccountphp?id=".$row['id']." class='btn red'>Deactivate</a>"; 
				
											else 
												echo 
						"<a href=activateaccountphp?id=".$row['id']." class='btn green'>Activate</a>"; 
