                             ...
                             <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
								  ...
								  <label class="col-sm-2 control-label no-padding-right" for="form-field-1">ራእይ/ልእክቶ/ክብርታት:  </label>
										<select  class="col-xs-9 col-sm-1"  id="form-field-1"  required  name="type" id="type">
													...
													<option value="ራእይ"> ራእይ </option>
													<option value="ልእክቶ">ልእክቶ </option>
													<option value="ክብርታት">ክብርታት </option>
										...
										<div class="form-group">
								  <label class="col-sm-2 control-label no-padding-right" for="form-field-1">ራእይ/ልእክቶ/ክብርታት:  </label>
										<textarea id="form-field-1" name="textvissionmission" rows="8" cols="50">
...
if (isset($_POST['save'])) {
    ...
    $q = "INSERT INTO `visionmission`(`id`, `type`, `textvissionmission`) VALUES (NULL, ?, ?)";

    // Prepare the statement
    if ($stmt = mysqli_prepare($conn, $q)) {
        // Bind the parameters to the prepared statement
        mysqli_stmt_bind_param($stmt, "ss", $type, $textvissionmission); // "s" for string (both parameters)

        // Execute the prepared statement
        if (mysqli_stmt_execute($stmt)) {
            echo '<p class="success" style="color:#390">Data Inserted Successfully</p>';
			//  Record log activity
				$ip = $_SERVER['REMOTE_ADDR'];
				$agent = $_SERVER['HTTP_USER_AGENT'] ?? null;
			   insertLog($conn, $useridad, $username, "Inserted"," Value Inserted Successfully.", "success", $ip, $agent);
            echo '<meta content="6;vissionmission" http-equiv="refresh" />';
        } else {
            echo '<p style="color:red">Error: Data not inserted. Please try again.</p>';
        }
...
?>
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3>ዝርዝር ባህግታት </h3></center>
					...
					<div id="dt">
										...
										<thead>
													<tr>
														...
														<th>ዓይነት</th>
														<th> ራእይ/ልእክቶ/ክብርታት</th>
														
														<th><center>ተግብር</center></th>
													</tr>
												</thead>
    ...
    if ($stmt = mysqli_prepare($conn, $q)) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            $id = $row['id'];
            $type = $row['type'];
            $textvissionmission = $row['textvissionmission'];
            $i++;
...
?>
													...
													<tr>
														...
														<td class="hidden-480"><?php echo $row['textvissionmission']; ?></td>
														
														
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="editvissionmission<?php  echo '?vmid='.$id; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
