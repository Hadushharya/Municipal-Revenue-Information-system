	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3> ተወሲንሎም ናብ ትሓዚ ገንዘብ ዘይተልኣኩ ሽም ዝርዝር    </h3></center>
					...
					<div id="dt">
								...
								// Define your values
						$payment_status = 'notapproved';
						$cashier_status = 'notapproved';

						// Prepare the SQL statement
						$stmt = $conn->prepare("SELECT * FROM `clientslanddatataxdecides` WHERE forpayment_status = ? AND forcashierstatus = ? ORDER BY id DESC");

						// Bind parameters
						$stmt->bind_param("ss", $payment_status, $cashier_status);
								 ...
								 $userid=$row['userid'];
									...
									?>
													<tr>
														...
														<td><?php  echo $clean=$row['clean'];  ?></td>
		   ...
		   insertLog($conn, $userid, $username, "Viewing", "Decided Data Available in Tax Deciding.", "success", $ip, $agent);                          
		 ?>
												</tbody>
											</table>
										</div>
