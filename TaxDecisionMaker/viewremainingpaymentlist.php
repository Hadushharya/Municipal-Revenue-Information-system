...
<?php include('../db/connection.php'); ?>
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3>ዝርዝር ናብ ኣወሳስና ግብሪ ዘይተልኣኩ   </h3></center>
					<div id="dt">
								...
								$i=0;
								//$cont_id=0;
                                $q="SELECT * FROM `clientslanddata` where forpayment_status='notapproved' order by id desc";
                            $i=0;
		   ...
		   insertLog($conn, $userid, $username, "Viewing", "List of Data Available in Data Collectors", "success", $ip, $agent); ?>
												</tbody>
											</table>
										</div>
										</div>
