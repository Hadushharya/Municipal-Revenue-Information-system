   ...
   ?>
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
				...
				<center><h3>ዝተወሰነሎም   ዘይከፈሉ ሽም ዝርዝር    </h3></center>
					...
					<div id="dt">
								...
								//$cont_id=0;
                                 ...
                                 $q="SELECT * FROM `clientslanddatataxdecides` where   forpayment_status='approved' and forcashierstatus='notapproved'   order by id desc";
                            $i=0;
		   ...
		   insertLog($conn, $userid, $username, "Viewing", "Decided Tax List and Sent to Cashier.", "success", $ip, $agent);  ?>
												</tbody>
											</table>
										</div>
										</div>
