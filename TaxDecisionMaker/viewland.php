...
<?php include('../db/connection.php'); ?>
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3> ዝርዝር ተጠቀምቲ መሬት   </h3></center>
					<div id="dt">
						 ...
						 <?php
								$i=0;
                                $q="SELECT * FROM `clientslanddata` where forpayment_status='Approved' order by id desc";
                            $i=0;
		   ...
		   insertLog($conn, $userid, $username, "Viewing", "Data Comming From Data Collectors are viewed", "success", $ip, $agent); ?>
												</tbody>
											</table>
										</div>
										</div>
