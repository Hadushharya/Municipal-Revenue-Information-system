...
$q = "SELECT * FROM `clientslandtransactions` WHERE  status = ?";
$status="pending";
if ($stmt = mysqli_prepare($conn, $q)) {
...
?>
													...
													<tr>
														...
														<td> <?php echo number_format($rowc['totalvalue'],2); ?> </td>
														<td> <?php echo number_format($rowc['estimated_value'],2); ?> </td>
														...
														<td><?php $registered_time=$rowc['registered_time']; 
															...
															<td> 
													<?php if($rowc['status']=="pending"){
																		
                                                             echo "<a href=sellinglandapprovetax?id=".$id." class='btn red'>Approve</a>";
																			}
						                                 else{
							                               echo "error";
														   			 //  Record log activity
