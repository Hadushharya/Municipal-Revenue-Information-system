	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3>ዝርዝር ናብ ኣወሳስና ግብሪ ዘይተልኣኩ   </h3></center>
					<div id="dt">
							...
							// Use a prepared statement for secure execution
							$status = 'notapproved';
							$stmt = $conn->prepare("SELECT * FROM `clientslanddata` WHERE forpayment_status = ? ORDER BY id DESC");
							...
							?>
								...
								<?php  } //  Record log activity
										...
										insertLog($conn, $useridc, $username, "Viewed", "viewed, unsent Data to Tax Deciders.", "success", $ip, $agent);  ?>
												</tbody>
											</table>
										</div>
										</div>
