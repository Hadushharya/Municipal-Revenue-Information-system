			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3> ዝርዝር ተጠቀምቲ መሬት   </h3></center>
					<div id="dt">
							...
							$q = "SELECT * FROM `clientslanddata` WHERE forpayment_status = ? ORDER BY id DESC";
							$stmt = $conn->prepare($q);
							$status = 'Approved';
								...
								$south=$row['south'];
								 ...
								 $buildingplan=$row['buildingplan'];
									...
									?>
										...
										insertLog($conn, $useridc, $username, "Collected Data", "Collected Data by Data Collectors.", "success", $ip, $agent);  ?>
												</tbody>
											</table>
										</div>
										</div>
