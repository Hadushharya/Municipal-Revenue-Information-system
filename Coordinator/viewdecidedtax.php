			...
			<form method="POST" enctype="multipart/form-data">
				...
				<center><h3>ዝርዝር ተጠቀምቲ መሬት   </h3></center>
					...
					<div id="dt">
								...
								$q = "SELECT * FROM `clientslanddatataxdecides` WHERE forpayment_status = ? AND forpayment_status = ? ORDER BY id DESC";
								$stmt = $conn->prepare($q);
								$status = 'approved';
								...
								while ($row = mysqli_fetch_array($result)) {
									...
									?>
										...
										insertLog($conn, $useridc, $username, "Decided Tax", "Tax Decided by Tax Deciders.", "success", $ip, $agent);  ?>
												</tbody>
											</table>
										</div>
										</div>
