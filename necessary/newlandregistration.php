	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<button type="submit" name="import" class="btn btn-primary btn-sm">Import</button><center><h3>ዝርዝር ኣብ  ሽረ  እንዳስላሴ ዝርከቡ  ተገልገልቲ መሬት   </h3></center>
					<div id="dt">
						<input type="text" name="barcode" style="width: 360px;" placeholder="ድለ...." id="filter" tabindex="1" /><a rel="facebox" id="addd" href="newlandclientreg">ሓደሽቲ መዝግብ</a><br><br>
									<?php	
			...
			if(strtolower($fileinfo['extension']) == 'csv'){
				...
				if($_FILES['file']['size'] > 0){
                   ...
                   while(($impData = fgetcsv($file, 1000, ',')) !== FALSE){
					if(empty($impData[0])){
					//$message= "Data can not imported becuase of dublicated name or empyty. ";
					}else{
						$sql = "INSERT INTO `revenue`.`clientslanddata` (`id`,`fullname`, `kebele`, `block`, `east`, `west`, `north`, `south`,
						`filenumber`, `levelofplace`, `occupiedyear`, `mainservice`, `kindofvolumeofland`,`area`, `beginofconstruction`, 
						`endofconstruction`, `beginpayment`,`endpayment`,`amountofpay`,`paymentyear`,`unpaidyear`,`day`,`month`,`maincash`,
						`bankinterest`,`diffrence`,`punishment`,`differencewithpunishment`,`total`,`receiptnumber`,`siteplan`,`buildingplan`) 
						VALUES('".$impData[0]."', '".$impData[1]."','".$impData[2]."','".$impData[3]."','".$impData[4]."','".$impData[5]."',
						'".$impData[6]."','".$impData[7]."','".$impData[8]."','".$impData[9]."','".$impData[10]."','".$impData[11]."',
						'".$impData[12]."','".$impData[13]."','".$impData[14]."','".$impData[15]."','".$impData[16]."','".$impData[17]."',
						'".$impData[18]."','".$impData[19]."','".$impData[20]."','".$impData[21]."','".$impData[22]."','".$impData[23]."',
						'".$impData[24]."','".$impData[25]."','".$impData[26]."','".$impData[27]."','".$impData[28]."','".$impData[29]."',
						'".$impData[30]."','".$impData[31]."')";
						$query = mysqli_query($conn, $sql);
						if($query){
							$message= "Data imported successfully";
						}
						else{
							$message= "Data cannot imported because of duplicated name or empty name. ";
						}
					}
				   }
		...
		$message= "Please import a file first"; 
										...
										<thead>
													<tr>
														...
														<th colspan='12'class="green"> ክፍሊት ዝምልከት	</th>	
														...
														<th rowspan='2' class="green"> ዝከፍሎ  መጠን ገንዘብ  </th>
														<th  rowspan='2' class="green"> ዝክፈለሉ እዋን   </th>
														<th rowspan='2' class="green"> ዘይከፈለሉ እዋን  </th>
														<th  rowspan='2' class="green"> መዓልቲ  </th>
														<th rowspan='2' class="green"> ወርሒ  </th>
														<th  rowspan='2' class="green"> ዋና ገንዘብ  </th>
														<th rowspan='2' class="green"> ባንኪ ወለድ  </th>
														<th  rowspan='2' class="green"> ኣፈላላይ  </th>
														<th rowspan='2' class="green"> ቅፅዓት  </th>
														<th  rowspan='2' class="green"> ኣፈላላይ  </th>
														<th rowspan='2' class="green"> ድምር  </th>
														<th  rowspan='2' class="green"> ዝከፈለሉ ቅብሊት ቁፅሪ   </th>
								 ...
								 $buildingplan=$row['buildingplan'];
									...
									?>
													<tr>
														...
														<td><?php echo $paymentyear; ?></td>
														<td><?php echo  $unpaidyear; ?></td>
														<td><?php echo $day; ?></td>
														<td><?php echo $month; ?></td>
														<td> <?php echo $maincash; ?> </td>
														<td><?php echo $bankinterest; ?></td>
														<td><?php echo $diffrence; ?></td>
														<td><?php echo $punishment; ?></td>
														<td><?php echo $differencewithpunishment; ?></td>
														...
														<td>
															...
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="delete_clientlanddetail<?php  //echo '?acc='.$con_codee; ?>" class="tooltip-success" data-rel="tooltip" title="Delete">
